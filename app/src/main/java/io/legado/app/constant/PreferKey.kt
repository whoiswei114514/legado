...
object PreferKey {
    ...
    const val searchConcurrency = "searchConcurrency"
    const val captchaAiEnabled = "captchaAiEnabled"
    const val captchaAiApiKey = "captchaAiApiKey"
    const val captchaAiModel = "captchaAiModel"
    const val captchaAiBaseUrl = "captchaAiBaseUrl"
